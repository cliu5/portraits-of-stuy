...
def create_stories_table(cur):
    ...
    command = "CREATE TABLE IF NOT EXISTS stories (id INTEGER PRIMARY KEY, title TEXT NOT NULL, body TEXT NOT NULL, latestAddition TEXT NOT NULL, total_rating INTEGER)" #build SQL stmt, save as string
    cur.execute(command) #run SQL statement
